...
function message(){
   ...
   function educationforaperson(classnumber : number){
if (classnumber == 1) {
...
function ATMMoney(accountbalance:number,pinnumber:number,withdrawabalance:number,accountnumber:number){
...
function greatestvaluecheck(num1:number,num2:number,num3:number,
...
function smallestvalue(number1:number,number2:number,number3:number,
    number4:number,number5:number){
...
function calculatepercentage(givenvalue:number,totalvalue:number) {
...
function percentagecalculate(pricevalue:number) 
{
if (pricevalue >= 100) {
    var discount = 0.1; // 10 %
...
function categoryperson (ageofperson : number){
...
const temperaturechange =(fahrenheit:number)=> {
...
const yeargiven = (givenyear : number)=>{
if (givenyear % 4 == 0) {
...
function numberday(daynumber:number) {
...
function totalunits(numberunits :number , billamount : number) {
//var numberunits = 250;
